function [ nSteps, t, E_t, T_t, R2_t, D_t Fmax_t Frms_t] = langevinMD_PBC4_PR_2( nAtoms, gamma, targetTemp, P_target, timestep, equilTime, runTime, nocells1D, h,V,mdmode, startconf)
...
%       vel = vel'; 
    ...
    function V_update(halfstep,quarterstep)
       % (see my book) for Louvillian-propagated expression used here
